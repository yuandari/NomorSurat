            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4 text-right">
                ...
                <div class="col-md-10 text-right">
                    <a class="nav-link">
                        ...
                        <img class="img-profile rounded-circle" src="<?= base_url('assets/img/profile/') . $user['photo'] ?>" width="40px" height="40px">
                    </a>
                </div>
            </ul>
        </div>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link " href="<?= base_url('Pegawai/Nomor') ?>">
                            <div class="nav-link-icon">
                        ...
                        <a class="nav-link pb-2 pt-1" href="<?= base_url('Pegawai/DataKlasifikasi') ?>">
                            <div class="nav-link-icon">
                        ...
                        <!-- Nav Item - Klasifikasi Surat -->
                        <a class="nav-link pb-2 pt-1" href="<?= base_url('Pegawai/DataPejabat') ?>">
                            <div class="nav-link-icon">
                                <i class="fas fa-silid fa-briefcase"></i>
                        ...
                        <a class="nav-link pb-2 pt-1" href="<?= base_url('Pegawai/ganti_password') ?>">
                            <div class="nav-link-icon">
